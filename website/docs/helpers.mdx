...
Overloaded method which reduce the boilerplate required for the `setRoot` command.
...
Overloaded method which reduce the boilerplate required for the `showModal` command.
...
Overloaded method which reduce the boilerplate required for the `showOverlay` command.
